    ...
    return <View
        ...
        <FlatList
            ...
            renderItem={({ item, index, separators }) => (
                <View style={{ height: 50, backgroundColor: colors.card, borderRadius: 12, padding: 15 }}>
...
function MealAdd({ navigation }: AddProps): React.JSX.Element {
    ...
    return <View style={{ height: '100%', padding: 15, gap: 20 }}>
        ...
        <View style={{ alignItems: 'center' }}>
            <Icon.Button
                ...
                onPress={() => navigation.navigate({
                    name: 'List',
                    params: { newMeal: { id: IdGenerator.generate(), name: name, ingredients: [], complexity: complex } },
                    merge: true,
                })}
            >
                {t('meals.save')}
